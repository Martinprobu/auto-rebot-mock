...
export class TrackerService {
  ...
  public async fetch(
    ...
    try {
      ...
      this.logger.debug("stateJson ====== ", JSON.stringify(stateJson));

      this.logger.debug("stateJson2 ====== ", JSON.stringify(state));

      this.logger.debug("defaultState ====== ", JSON.stringify(defaultState));
